"""AgentInstruct transformation prompts.

Based on the Microsoft AgentInstruct paper, these prompts implement
proper instruction transformation flows with LLM reasoning.
...
6. Extraction - Pull specific information
7. Reasoning - Multi-step logical thinking
"""
...
# Map of transformation types to their prompts
TRANSFORM_PROMPTS = {
    "qa": TRANSFORM_QA,
